...
class Prediction_Data_validation:
    ...
    """ This class will handle all the validation done on the Raw Training Data. """
    ...
    def manualRegexCreation(self):
        ...
        regex = "['bikeshare']+['\_']+['prediction']+['\_']+['data']+\.csv"
        return regex


    def createDirectoryForGoodBadRawData(self):

        """ This method creates directories to store the Good Data and the Bad Data after validating the training data.
            On Failure, it gives OSError """
    ...
    def deleteExistingGoodDataTrainingFolder(self):
        ...
        """ This method deletes the directory made to store the Good Data after loading the data in the table.
    ...
    def validationFileNameRaw(self,regex,LengthOfDateStampInFile,LengthOfTimeStampInFile):
        ...
        """ This function validates the name of the training csv files as per given name in the schema!
            ...
            to Bad Raw Data folder. Else, file is moved to Good Raw Data.
    ...
    def deletePredictionFile(self):
        ...
        if os.path.exists('/Users/umadevipotnuru/PycharmProjects/BikeShare/prediction_output_files/predictions.csv'):
            os.remove('/Users/umadevipotnuru/PycharmProjects/BikeShare/prediction_output_files/predictions.csv')
